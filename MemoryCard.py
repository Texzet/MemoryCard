...
questions_list.append( Question("Яка планета знаходиться далі всіх від Сонця?", "Нептун", "Меркурій", "Уран", "4546Б"))
questions_list.append( Question("Що є міддю?", "Cu", "Ag", "Au", "Cf"))
questions_list.append( Question("У якій країні знаходиться вершина Евереста?", "Непал", "Китай", "Бутан", "Монголія"))
questions_list.append( Question("У якому році почалась перша світова війна?", "1914", "1923", "1907", "1889"))
questions_list.append( Question("Що є найкращим провідником електрики?", "Мідь", "Золото", "Залізо", "Вода"))
...
def check_answer():
    ...
    if answers[0].isChecked():                # Перша кнопка — правильна (після shuffle)
        ...
        print("Набрано балів", "Пройдено запитань,")
